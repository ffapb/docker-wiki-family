...
--
-- Host: 0.0.0.0    Database: ffa_re_pnp
--
-- https://www.mediawiki.org/wiki/Manual:Backing_up_a_wiki#MySQL
-- > docker-compose exec db mysqldump -h 0.0.0.0 -u root --password=my-secret-pw --default-character-set=binary ffa_re_pnp > build/db/init.db/create_mediawiki_tables.sql
-- ------------------------------------------------------
...
INSERT INTO `page` VALUES (1,0,'Main_Page','',0,1,0.068590381087,'20170225021915',NULL,1,717,'wikitext',NULL);
...
INSERT INTO `revision` VALUES (1,1,1,'',0,'MediaWiki default','20170225021915',0,0,717,0,'6wzmf83s5t2n0ntohe3bmgww4dea1u3',NULL,NULL);
...
INSERT INTO `user` VALUES (1,'Shadi Akiki','',':pbkdf2:sha512:30000:64:7CMKlzqEGPXRZCkSdOtqyg==:rMrgNYI8nMX81ok8+C0IHVYo+Dk6Ez+xX9m+T3FyMtdw8gOHAlPy2gXwe0UY6m68ZzIxgZt1qfXEzdu14iScNA==','',NULL,'s.akiki@ffaprivatebank.com','20170225021921','d7b82927518cda9494afc4b2889df280',NULL,NULL,NULL,'20170225021914',0,NULL);
...
-- Dump completed on 2017-02-25  2:27:11
